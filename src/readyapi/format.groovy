...
try {
    ...
    String referenceFilePath = context.expand( '${#TestCase#formatReferenceFilePath}' )
...
class LogUtils {
    ...
    public static void setProcess(String id, String description, String stepsNumber) {
        ...
        println("$processID - $processDescription:")
    }
    ...
    public static void print(Boolean succeed = true) {
        ...
        println("    [$stepID/$processStepsNumber] $stepDescription ($result)")
    }
